<?php $__env->startSection('title', 'Helpdesk E-Learning Cakrawala'); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/helpdesk.css')); ?>">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('helpdesk', 'nav-active'); ?>
        ...
        <div class="flex-row container-group">
            <div id="img-slider" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="<?php echo e(asset('img/helpdesk-1.jpg')); ?>" class="d-block w-100" alt="...">
                  ...
                  <div class="carousel-item">
                    <img src="<?php echo e(asset('img/helpdesk-2.jpg')); ?>" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Belajar</h5>
                  ...
                  <div class="carousel-item">
                    <img src="<?php echo e(asset('img/helpdesk-3.jpg')); ?>" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Ilmu</h5>
            ...
            <div class="flex-column container-contact">
                ...
                <div class="flex-row contact-item">
                    <img src="<?php echo e(asset('img/icon/helpdesk-location.svg')); ?>" alt="address">
                    <span class="montserrat">Jl. Senopati VIIB, Jakarta - 60135 Indonesia</span>
                </div>
                <div class="flex-row contact-item">
                    <img src="<?php echo e(asset('img/icon/helpdesk-call.svg')); ?>" alt="address">
                    <span class="montserrat">+62-8155-3507-248</span>
                </div>
                <div class="flex-row contact-item">
                    <img src="<?php echo e(asset('img/icon/helpdesk-message.svg')); ?>" alt="address">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template.system', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Raffi\Transfer File Raffi\Pweb\Pemrogaman Web PRAK\E-LearningCakrawala-main\E-LearningCakrawala-main\resources\views/helpdesk.blade.php ENDPATH**/ ?>